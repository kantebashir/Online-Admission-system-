...
# Creating models for the accounts of the users and the institution where they are applying including acct reg and passswd settings
#the accounts will have all the account related functionalities
...
class Profile(models.Model):
    ...
    profile_pic = models.ImageField(upload_to="images", default="profile/default.png")
